...
public class OrderDaoImpl implements OrderDao {
    ...
    public PaginatedResult<Order> findAdminOrders(String query, int page, int pageSize) {
        ...
        if (query != null && !query.trim().isEmpty()) {
            ...
            jpql.append(" AND (LOWER(o.orderId) LIKE LOWER(:query) OR LOWER(o.user.username) LIKE LOWER(:query))");
            countJpql.append(" AND (LOWER(o.orderId) LIKE LOWER(:query) OR LOWER(o.user.username) LIKE LOWER(:query))");
